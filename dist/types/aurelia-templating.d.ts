 ...
 */
export interface ComponentPropertyChanged {
...
*/
export declare const animationEvent: {
	readonly enterBegin: "animation:enter:begin";
	readonly enterActive: "animation:enter:active";
	readonly enterDone: "animation:enter:done";
	readonly enterTimeout: "animation:enter:timeout";
	readonly leaveBegin: "animation:leave:begin";
	readonly leaveActive: "animation:leave:active";
	readonly leaveDone: "animation:leave:done";
	readonly leaveTimeout: "animation:leave:timeout";
	readonly staggerNext: "animation:stagger:next";
	readonly removeClassBegin: "animation:remove-class:begin";
	readonly removeClassActive: "animation:remove-class:active";
	readonly removeClassDone: "animation:remove-class:done";
	readonly removeClassTimeout: "animation:remove-class:timeout";
	readonly addClassBegin: "animation:add-class:begin";
	readonly addClassActive: "animation:add-class:active";
	readonly addClassDone: "animation:add-class:done";
	readonly addClassTimeout: "animation:add-class:timeout";
	readonly animateBegin: "animation:animate:begin";
	readonly animateActive: "animation:animate:active";
	readonly animateDone: "animation:animate:done";
	readonly animateTimeout: "animation:animate:timeout";
	readonly sequenceBegin: "animation:sequence:begin";
	readonly sequenceDone: "animation:sequence:done";
};
/**
...
export declare const SwapStrategies: {
	before(viewSlot: ViewSlot, previous: View, callback: any): any;
	with(viewSlot: ViewSlot, previous: View, callback: any): any;
	after(viewSlot: ViewSlot, previous: View, callback: any): Promise<any>;
};
/**
...
*/
export declare function inlineView(markup: string, dependencies?: Array<string | Function | ViewStrategyDependencyConfig>, dependencyBaseUrl?: string): any;
/**
...
export declare type IStaticViewCustomElement = Function & {
...
*/
export declare function viewResources(...resources: any[]): (target: any) => void;
/**
...
export declare function _hyphenate(name: string): string;
export declare function _isAllWhitespace(node: any): boolean;
